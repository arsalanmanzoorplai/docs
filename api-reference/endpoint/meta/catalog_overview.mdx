...
<Card title="📂 Get Catalog List">
    Retrieve all product catalog linked to your business account.

    <CardGroup cols={2}>
        <Card title="Get Catalog List" href="/api-reference/endpoint/meta/get_catalog_list" />
    </CardGroup>
</Card>
...
<Card title="🔄 Create Catalog Products Feed">
    Create a data feed (CSV/XML/URL) to bulk upload or sync product data with your catalog.
    
    <CardGroup cols={2}>
        <Card title="Create Catalog Products Feed" href="/api-reference/endpoint/meta/create_catalog_products_feed" />
    </CardGroup>
</Card>


<Card title="📥 Get Catalog Products Feed">
    List configured product feeds, check statuses, and inspect import logs.
    
    <CardGroup cols={2}>
        <Card title="Get Catalog Products Feed" href="/api-reference/endpoint/meta/get_catalog_products_feed" />
    </CardGroup>
</Card>

<Card title="🎯 Create Catalog Product Set">
    Create a product set by filtering items (e.g., via `retailer_id` or metadata).
    
    <CardGroup cols={2}>
        <Card title="Create Catalog Product Set" href="/api-reference/endpoint/meta/create_catalog_product_set" />
    </CardGroup>
</Card>
...
<Card title="✏️ Edit Catalog Product Set">
    Modify an existing product set’s filters, name, cover image, or visibility.
    
    <CardGroup cols={2}>
        <Card title="Edit Catalog Product Set" href="/api-reference/endpoint/meta/edit_catalog_product_set" />
    </CardGroup>
</Card>
