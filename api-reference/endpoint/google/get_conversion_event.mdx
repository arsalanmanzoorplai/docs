...
description: "This endpoint retrieves the available conversion event categories linked to a Google Ads account. Use it to fetch and display valid options when setting up a campaign with a conversion-based objective."
---
