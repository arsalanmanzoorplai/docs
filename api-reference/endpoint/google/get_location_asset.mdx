...
description: "This endpoint retrieves the location assets linked to the user’s Google Ads account. These assets include details such as the location name, ID, and place ID, which are used to show business locations on Google Maps or in location-based ad extensions. Use this to fetch and manage your connected business locations."
---
