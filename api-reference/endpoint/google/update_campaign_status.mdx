...
description: "This endpoint allows you to change the current status of an existing Google Search campaign. Depending on your needs, you can enable, pause, or remove the campaign by updating its status using the provided campaign ID. Use this to control whether your campaign is active, temporarily halted, or permanently deleted from delivery."
---
