...
description: "This endpoint creates a new lead form asset for a Google Ads campaign. A lead form allows you to collect user information directly within your ad using customizable fields, headlines, call-to-action text, and a privacy policy link. Use this when you want to generate leads without requiring users to visit your website."
---
...
<ParamField body="call_to_action_description" type="string" required>
	Description for the call to action button
</ParamField>
...
Input fields for the lead form.
